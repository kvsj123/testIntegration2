...
<body class="flex flex-col h-screen">
  <header>
    ...
    <form method="POST" action="{{ route('register') }}" class="mt-20">
        ...
        <a href="{{ route('deelnemer.register') }}"
           class="block w-full px-4 py-2 mb-4 font-medium text-center text-black transition-colors border-2 border-black rounded-3xl hover:bg-teal-600 hover:text-white">
          Deelnemer
        </a>

        <a href="{{ route('dbedrijf.register') }}"
